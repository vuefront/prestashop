...
class Blog_CategoryVFResolver extends VFResolver
{
    ...
    public function category($args)
    {
        ...
        $category = $this->model_blog_category->getCategory($args['id']);
    ...
    public function categoryList($args)
    {
        ...
        $categories = $this->model_blog_category->getCategories($filter_data);
